      ...
      <main className="container mx-auto px-4 py-16">
        <nav className="flex justify-between items-center mb-16">
          ...
          <div>
            <Link
              href="/login"
              className="px-4 py-2 rounded text-purple-700 hover:text-purple-900"
            >
              Login
            </Link>
            <Link
              href="/login"
              className="ml-4 px-4 py-2 rounded bg-purple-200 text-purple-700 hover:bg-purple-300"
            >
              Sign Up
            </Link>
          </div>
        ...
        <div className="flex flex-col md:flex-row items-center justify-between">
          <div className="md:w-1/2 mb-8 md:mb-0">
            ...
            <Link
              href="/login"
              className="inline-block px-6 py-3 rounded bg-purple-500 text-white hover:bg-purple-600"
            >
              Get Started
            </Link>
          </div>
        ...
        <footer className="mt-32 py-8 border-t border-gray-200">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-500 mb-4 md:mb-0">© 2025 Zeal. All rights reserved.</p>
